...
class ProductPage(BasePage):
    ...
    def should_be_success_alert(self):
        assert self.is_element_present(*ProductPageLoacators.ALERT_ADDED_TO_BASKET), "There isn't success alert"
    ...
    def should_be_alert_with_basket_cost(self):
        assert self.is_element_present(*ProductPageLoacators.ALERT_WITH_BASKET_COST), "There isn't alert_with_basket_cost"
